...
/* This patch allows st to reize to any pixel size rather than snapping to
...
/* This patch adds dustom rendering of lines/blocks/braille characters for
 ...
 * You need to uncomment the corresponding line in config.mk to use the harfbuzz
 * library when including this patch. You need to uncomment the corresponding
 * lines in Makefile when including this patch.
 ...
 *      when transparent and rendered against a white background. This is
 * believed to be related to how the sixel graphics use RGB colors instead of
 * RGBA. A pull request or instructions for how to properly add alpha support
 * for sixel graphics would be very welcome.
 *
 * Note that you need to uncomment the corresponding lines in Makefile when
